...
The complete project repository — containing the full model parameter reference document (\path{ms_garch_full_models.pdf}, 112 pages), the estimation notebook (\path{code/Likelihood_Approximation_for_MS_GARCH.ipynb}), all CSV results for the 220 experimental cases, and the result visualisations — is publicly available at:
